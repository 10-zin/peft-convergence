...
#             optimizer, mode='min', factor=0.5, patience=2, verbose=True
    ...
    for epoch in range(args.num_epochs):
        ...
        for batch in eval_dataloader:
            with torch.no_grad():
                if model_type == "seq_cls":
                    ...
                    preds = [get_class_from_generated_text(t, label_map) for t in generated_texts]
                    labels = [get_class_from_generated_text(t, label_map) for t in decoded_labels]
        ...
        metrics = {
            "epoch": epoch,
            "eval_loss": eval_loss / num_eval_batches, # if model_type == "seq_cls" else 0.0,
            "accuracy": accuracy,
            "f1_score": f1,
